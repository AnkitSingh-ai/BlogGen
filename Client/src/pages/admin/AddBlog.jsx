...
formData.append('image', image);
  ...
  return (
    <div>
      ...
      <div className='bg-white w-full max-w-3xl mx-auto p-4 md:p-10 sm:m-10 rounded shadow'>

        <p>Upload thumbnail</p>
        <label htmlFor="image">
          <img src={!image ? assets.upload_area : URL.createObjectURL(image)} alt="Upload thumbnail" className='mt-2 h-16 rounded cursor-pointer' />
       ...
       {loading && (
        ...
        <button disabled={isAdding} type='submit' className='mt-4 px-6 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition-all'>{isAdding ? 'Adding... ' : 'Add Blog'}</button>

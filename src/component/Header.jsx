  ...
  return (
    <div className='mx-8 sm:mx-16 x1:mx-24 relative'>
        <div className='text-center mt-20 mb-8'>
            ...
            <h1 className='text-3xl sm:text-6xl  font-semibold sm:leading-16 text-gray-700'>Welcome to the Blog<span className='text-primary'>Gen</span></h1>
            <p className='my-6 sm:my-8 max-w-2xl m-auto max-sm:text-xs text-gray-500'>This is your space to think out loud, to share what matters, and to write without filters.
                Weather it's one word or a thousand, your story starts right here</p>

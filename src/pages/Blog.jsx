      ...
      <div>
        ...
        <div className='max-w-3xl mx-auto mb-10'>
          ...
          <form onSubmit={addComment} className='flex flex-col item-start gap-4 max-w-lg'>
            ...
            <textarea value={content} onChange={(e) => setContent(e.target.value)} className='w-full p-2 border border-gray-300 rounded outline-none h-48' rows={4} placeholder='Write your comment...' />
